...
> maintenance_work_mem = 128MB; максимальное количество ОП для операций типа VACUUM, CREATE INDEX, CREATE FOREIGN KEY. В нашем случае ставить больше большого смысла нет.     
